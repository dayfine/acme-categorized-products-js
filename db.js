var PBC = {
  Groceries: [
    {name: 'Apple', id: 1, price: 0.75, rating: 3.5},
    {name: 'Banana', id: 2, price: 0.59, rating: 4.0},
    {name: 'Juice', id: 3, price: 3.50, rating: 3.1},
    {name: 'Milk', id: 4, price: 5.90, rating: 4.2},
    {name: 'Pork Belly', id: 5, price: 7.45, rating: 4.5}
  ],
  Movies: [
    {name: 'War for the Planet of the Apes', id: 1, price: 9.99, rating: 8.1},
    {name: 'Doctor Strange', id: 2, price: 7.99, rating: 7.6},
    {name: 'Spider Man', id: 3, price: 11.99, rating: 8.0},
    {name: '2001: A Space Odyssey', id: 4, price: 10.99, rating: 8.3},
    {name: 'Alien', id: 5, price: 5.99, rating: 6.7}
  ],
  Gunplas: [
  ...
  'Soft drink': [
    {name: 'Diet Coke', id: 1, price: 0.99, rating: 5.0},
    {name: 'Pepsi', id: 2, price: 0.99, rating: 4.0},
    {name: 'Mountain Dew', id: 3, price: 0.99, rating: 4.5},
    {name: 'Iced Tea', id: 4, price: 0.99, rating: 4.7},
    {name: 'Sprite', id: 5, price: 0.99, rating: 4.5}
  ]
}
...
function createCategory (category) {
  if (category === '') throw new Error('Type something!')
